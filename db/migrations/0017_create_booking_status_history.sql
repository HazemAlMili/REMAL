CREATE TABLE booking_status_history (
    ...
    CONSTRAINT ck_booking_status_history_old_status CHECK (old_status IS NULL OR old_status IN ('prospecting', 'relevant', 'noanswer', 'notrelevant', 'booked', 'confirmed', 'checkin', 'completed', 'cancelled', 'leftearly')),
    CONSTRAINT ck_booking_status_history_new_status CHECK (new_status IN ('prospecting', 'relevant', 'noanswer', 'notrelevant', 'booked', 'confirmed', 'checkin', 'completed', 'cancelled', 'leftearly'))
);
