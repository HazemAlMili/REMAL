-- ============================================================================
-- Migration:   0052_align_reporting_views_with_pipeline
-- Title:       Align booking and finance reporting with current status models
-- Database:    PostgreSQL 16
-- Depends on:  0041_create_reporting_booking_daily_summary_view
--              0042_create_reporting_finance_daily_summary_view
--              0051_allow_superseded_invoice_status
-- ============================================================================

BEGIN;

ALTER VIEW reporting_booking_daily_summary
    RENAME COLUMN pending_bookings_count TO prospecting_bookings_count;
