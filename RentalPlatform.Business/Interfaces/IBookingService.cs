...
{
    Task<IReadOnlyList<Booking>> GetAllAsync(string? bookingStatus = null, Guid? assignedAdminUserId = null, Guid? clientId = null, Guid? ownerId = null, string? search = null, CancellationToken cancellationToken = default);
