                      ...
                      >
                        <div className="relative aspect-[4/3] overflow-hidden bg-gray-100">
                          ...
                          <div className="absolute top-4 right-4 z-10 flex gap-2 flex-wrap justify-end">
                            <Badge
                              variant="success"
                              className="backdrop-blur-md bg-white/90 text-brand-950 font-black shadow-md border-none"
                            >
                              <Star className="w-3 h-3 ml-1 fill-brand-950 inline" />{" "}
                              {unit.rating}
                            </Badge>
                        ...
                        <div className="p-5 flex flex-col flex-grow">
                          <div className="flex justify-between items-start mb-2">
                            <div className="text-xs text-brand-600 font-black uppercase tracking-wider">
                              {unit.type} •{" "}
                              {
                                MOCK_PROJECTS.find((a) => a.id === unit.projectId)
                                  ?.name
                              }
                            </div>
                          </div>
                          <h3 className="text-lg font-black text-brand-950 mb-1 leading-tight line-clamp-1">
                            {unit.name}
                          </h3>
                          <div className="text-sm font-medium text-gray-500 mb-4 line-clamp-1">
                            {unit.description}
                          </div>
