...
export default function ClientLoginPage() {
  ...
  return (
    <div className="w-full max-w-md rounded-[2rem] border border-white/70 bg-white p-8 shadow-premium sm:p-10">
      <div className="mb-6">
        <div className="text-sm font-bold uppercase tracking-[0.24em] text-accent-600">Client access</div>
        <h1 className="mt-3 text-3xl font-black text-gray-900">تسجيل دخول العميل</h1>
        <p className="mt-2 text-sm leading-6 text-gray-500">تابع حجوزاتك وابدأ الحجز من نفس الرحلة.</p>
      </div>
      ...
      <div className="mt-6 flex items-center justify-between text-sm text-gray-500">
        <Link href={ROUTES.authClientRegister} className="font-semibold text-brand-700 hover:underline">إنشاء حساب</Link>
